...
var windowsZoneMapping = map[string]string{
...
func knownWindowsZoneMapping() map[string]string {
	mapping := make(map[string]string, len(windowsZoneMapping))
	for tzid, iana := range windowsZoneMapping {
		mapping[tzid] = iana
	}
	return mapping
}
